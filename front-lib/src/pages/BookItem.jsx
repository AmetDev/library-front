...
const CartBook = () => {
    ...
    return (
        <div className='flex justify-content-center p-5 '>
           <div className='bg-gray-500 p-5 ml-3'> {!clickedElement.volumeInfo.imageLinks? `sorry, we are don't find img :(`:<img className='xl:w-[200px] h-[250px]  smm:w-[80px] h-[100px] lg:w-[90px] h-[250px]' src={clickedElement.volumeInfo.imageLinks.thumbnail} alt={clickedElement.volumeInfo.title}/>}</div>
           <div>
